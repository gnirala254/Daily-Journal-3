...
const connString = "mongodb://admin-gautam:gautam254@" +
                   ...
                   "/blogDB?authSource=admin&replicaSet=atlas-zaf4e8-shard-0&ssl=true";
...
app.get("/posts/:postId", function(req, res) {
  //const requestedTitle = _.lowerCase(req.params.publishTitle);
  ...
  // posts.forEach(function(post) { //New type of looping
